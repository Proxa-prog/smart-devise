...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_smooth_scroll__WEBPACK_IMPORTED_MODULE_6__["default"])(); // все скрипты должны быть в обработчике 'DOMContentLoaded', но не все в 'load'
...
var aboutCompanyButton = function aboutCompanyButton() {
  _variables__WEBPACK_IMPORTED_MODULE_0__["buttonShowMore"].addEventListener('click', function () {
    ...
    _variables__WEBPACK_IMPORTED_MODULE_0__["buttonShowMore"].textContent === 'Подробнее' ? _variables__WEBPACK_IMPORTED_MODULE_0__["buttonShowMore"].textContent = 'Свернуть' : _variables__WEBPACK_IMPORTED_MODULE_0__["buttonShowMore"].textContent = 'Подробнее';
...
var checkWindowWidth = function checkWindowWidth() {
  if (windowWidth >= _variables__WEBPACK_IMPORTED_MODULE_0__["TABLET_WIDTH"]) {
    for (var i = 0; i < _variables__WEBPACK_IMPORTED_MODULE_0__["textHidden"].length; i++) {
      _variables__WEBPACK_IMPORTED_MODULE_0__["textHidden"][0].classList.remove('about-company__text-show');
