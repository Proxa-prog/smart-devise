...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_accordion__WEBPACK_IMPORTED_MODULE_2__["default"])(); // все скрипты должны быть в обработчике 'DOMContentLoaded', но не все в 'load'
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var navigationBotton = document.querySelector('.footer__navigation-button');
var navigationList = document.querySelector('.footer__navigation-list');

var accordionOpen = function accordionOpen() {
  navigationBotton.addEventListener('click', function () {
    navigationList.style.display = 'block';
  });
};

/* harmony default export */ __webpack_exports__["default"] = (accordionOpen);
